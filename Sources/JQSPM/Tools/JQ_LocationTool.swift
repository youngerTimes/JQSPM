...
public enum JQ_MapNavigationType {
    ...
    @MainActor static let allValues = [BaiduMap,Amap,GoogleMap,qqMap]
...
/*
 ...
 腾讯地图：qqmap
 */
@MainActor public class JQ_MapNavigationTool{
    ...
    @available(*,deprecated,message: "使用JQ_LocationUtil")
...
public class JQ_LocationTool:NSObject,CLLocationManagerDelegate{
    ...
    @MainActor private static var _sharedInstance: JQ_LocationTool?

    @MainActor public class func instance() -> JQ_LocationTool {

...
//MARK: - UILabel
/// 数值增长
@MainActor public func JQ_AnnimationNumber(_ label:UIKit.UILabel,maxNumber:Int){
...
/// 数值增长 Double
@MainActor public func JQ_AnnimationNumber(_ label:UILabel,maxNumber:Double){
...
///   - startProgress: 开始
///   - endProgress: 结束
@MainActor public func JQ_AnimationTransition(fromView:UIView,type:CATransitionType,subType:CATransitionSubtype,startProgress:Float = 0,endProgress:Float = 1){
...
public class JQ_AnisTools:NSObject{
    ...
    @MainActor public static func frameYAni(_ view:UIView,offset:CGFloat,repeatCount:Float = 1,duration:Double = 0.3)->CABasicAnimation{
...
//    }
    ...
    ///   - view: 需要被执行的View
    ///   - duration: 持续时间
    @MainActor public static func sizeElastic(_ view:UIView, duration:Double = 0.3){
        UIView.animate(withDuration: duration) {
    ...
    ///   - hidden: 隐藏
    ///   - duration: 持续时间
    @MainActor public static func viewFadeOut(_ view:UIView,hidden:Bool,duration:Double = 0.3){
        if hidden{
...
public extension JQ_AnisTools{
    @MainActor static func MoveAnimation(_ cell:UITableViewCell,_ offset:Double,_ index:Int){
    ...
    @MainActor static func OverturnAnimation(_ cell:UITableViewCell,_ offset:Double,_ index:Int){
        let ScreenW = UIScreen.main.bounds.width
        cell.transform = CGAffineTransform(scaleX: -ScreenW, y: 0)
        UIView.animate(withDuration: 0.35, delay: Double(index) * 0.075, usingSpringWithDamping: 0.7, initialSpringVelocity: 1.0, options: .layoutSubviews, animations: {
            cell.transform = .identity
        }) { (complete) in
    ...
    @MainActor static func FadeDutAnimation(_ cell:UITableViewCell,_ index:Int){
    ...
    @MainActor static func FadeDutAnimationMove(_ cell:UITableViewCell,_ offset:Double,_ index:Int){
        cell.transform = CGAffineTransform(translationX: CGFloat(offset), y: 0)
    ...
    @MainActor static func BoundsAnimation(_ cell:UITableViewCell,_ offset:Double,_ index:Int){
    ...
    @MainActor static func BothwayAnimation(_ cell:UITableViewCell,_ offset:Double,_ index:Int){
    ...
    @MainActor  static func FillOneAnimation(_ cell:UITableViewCell,_ offset:Double,_ index:Int){
